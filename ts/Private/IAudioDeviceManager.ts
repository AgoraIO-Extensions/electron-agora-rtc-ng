...
export abstract class IAudioDeviceManager {
   ...
   *
   * @param deviceId The ID of the specified audio playback device. You can get the device ID by calling enumeratePlaybackDevices . Plugging or unplugging the audio device does not change the value ofdeviceId.The maximum length is MaxDeviceIdLengthType .
   *
   * @returns
   * 0: Success.< 0: Failure.
   */
   ...
   *
   * @param deviceId The ID of the audio recording device. You can get the device ID by calling enumerateRecordingDevices . Plugging or unplugging the audio device does not change the value ofdeviceId.The maximum length is MaxDeviceIdLengthType .
   *
   * @returns
   * 0: Success.< 0: Failure.
   */
   ...
   *
   * @param indicationInterval The time interval (ms) at which the SDK triggers the onAudioVolumeIndication callback. Agora recommends a setting greater than 200 ms. This value must not be less than 10 ms; otherwise, you can not receive theonAudioVolumeIndication callback.
   *
   * @returns
   * 0: Success.< 0: Failure.
   */
   ...
   *
   * @param indicationInterval The time interval (ms) at which the SDK triggers theonAudioVolumeIndication callback. Agora recommends setting a value greater than 200 ms. This value must not be less than 10 ms; otherwise, you can not receive theonAudioVolumeIndication callback.
   *
   * @returns
   * 0: Success.< 0: Failure.
   */
  ...
  /**
   * Releases all the resources occupied by theIAudioDeviceManager object.
   */
