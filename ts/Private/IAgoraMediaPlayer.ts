...
export abstract class IMediaPlayer {
   ...
   *
   * @param token The authentication field. See thesign field of the authentication information.
   *
   * @param ts The timestamp when the authentication information expires. See thets field of the authentication information.
   *
   * @returns
   * 0: Success.< 0: Failure.
   */
   ...
   * You can call this method to preload a media resource into the playlist. If you need to preload multiple media resources, you can call this method multiple times.After calling this method, if you receive thePlayerPreloadEventComplete event in the onPreloadEvent callback, the preload is successful; If you receive thePlayerPreloadEventError event in the onPreloadEvent callback, the preload fails.If the preload is successful and you want to play the media resource, call playPreloadedSrc ; if you want to clear the playlist, call stop .Agora does not support preloading duplicate media resources to the playlist. However, you can preload the media resources that are being played to the playlist again.
   *
   * @param src The URL of the media resource.
   *
   ...
   *
   * @param src The URL of the media resource in the playlist must be consistent with thesrc set by thepreloadSrc method; otherwise, the media resource cannot be played.
   *
   * @returns
   * 0: Success.< 0: Failure.
   */
